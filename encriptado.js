var resultado = document.getElementById("desencript");
...
function encriptar() {
    var nuevoTexto = "";
    var texto = document.getElementById("lecturatexto").value;
...
function desencriptar() {
    ...
    document.getElementById("desencript").value = nuevoTexto;
}
...
document.getElementById("encriptartext").onclick = encriptar;
document.getElementById("desencriptartext").onclick = desencriptar;
document.getElementById("copiarencriptado").onclick = copiarTexto;